...
count_mismatches("quiz2_human_mouse.output")
# count_mismatches("quiz2_human_chimp_0_2.output")
count_gaps("quiz2_human_mouse.output")
# count_gaps("quiz2_human_chimp_0_2.output")
# find_align_location("quiz1.input", "quiz1.output")