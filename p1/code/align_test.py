...
class TestAlignmentClasses(unittest.TestCase):
    ...
    def test_update_ix(self):
        ...
        # note - in this example, it should point to M -AND- Iy
        # check by hand!
        print(align.ix_matrix.get_pointers(3,2))
    ...
    def test_update_m(self):
        ...
        align.align_params.load_params_from_file(TEST_INPUT_FILE)
        # align.align_params.seq_a = "AATGC"
        # align.align_params.seq_b = "AGGC"

        align.m_matrix = ScoreMatrix("M", 5, 4)
        align.ix_matrix = ScoreMatrix("Ix", 5, 4)
        align.iy_matrix = ScoreMatrix("Ix", 5, 4)
        ...
        ### FILL IN for checking pointers! ###
        # note - in this example, it should point to M 
        # check by hand!
        print(align.m_matrix.get_pointers(3,3))
    ...
    def test_update_iy(self):
        ...
        # check by hand!
        print(align.iy_matrix.get_pointers(2,3))
        return
